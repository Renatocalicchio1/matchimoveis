...
- **Pendente antes de ativar de verdade**: (1) ~~adicionar env vars~~ ✅ feito; (2) validar com um envio de teste real (não a base toda) antes de clicar "Iniciar" em qualquer um dos 2 paineis — 1ª tentativa deu falso negativo por causa do engasgo de fila acima, repetir teste agora que a fila está limpa; (3) considerar se o histórico de bounce alto da campanha de captação (847/1.910) precisa de alguma limpeza de base antes de reativar, já que a causa raiz é lista suja, não o transporte — trocar só o transporte não resolve isso sozinho.
