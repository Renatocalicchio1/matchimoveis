// Copia todos os imóveis de uma conta pra outra.
...
//   node copiar-imoveis.js ORIGEM DESTINO
// Exemplo:
//   node copiar-imoveis.js ROD-P3V3 TIA-A6PG
...
if (!ORIGEM || !DESTINO) {
  console.error('Uso: node copiar-imoveis.js ORIGEM DESTINO');
  process.exit(1);
}
