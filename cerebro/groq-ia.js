...
CRÉDITOS (Match Coins): R$50 mínimo = 2.500 coins (R$1 = 50 coins). Valores EXATOS de consumo: cadastrar imóvel=15, editar imóvel=0 (grátis), importar XML=2 por imóvel, gerar XML portal=10, lead ativo por dia=0.2, qualificar lead via IA=30, match encontrado=20, vitrine WhatsApp=30, IA responde WA=30, follow-up automático=25, visita agendada pela IA=40, notificação proprietário=15, confirmação automática=15, nova lead=20, importar lead planilha=10. Para recarregar: acesse Créditos no menu → digite o valor (mínimo R$50) → clique em Adicionar créditos. NUNCA invente valores diferentes desses.
