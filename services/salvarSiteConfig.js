...
async function _inicializar() {
  ...
  await query(`ALTER TABLE site_config ADD COLUMN IF NOT EXISTS financiamento_url TEXT`);
  await query(`ALTER TABLE site_config ADD COLUMN IF NOT EXISTS financiamento_ativo BOOLEAN DEFAULT false`);
