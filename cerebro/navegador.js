...
const PAGINAS = {
  ...
  cadastro:   { rota:'/app/cadastro',  titulo:'Cadastrar Imovel', descricao:'Adicione imoveis manualmente ou via XML', keywords:['cadastrar','cadastro','novo imovel','adicionar imovel','importar xml','subir xml','url xml','feed xml'], oque_tem:['Formulario manual de cadastro','Upload de fotos','Importacao via URL de feed XML','Botao testar URL XML'], filtros:[], botoes:['Salvar imovel','Testar URL XML','Importar XML agora'] },
  ...
  portais:    { rota:'/app/portais',   titulo:'Portais / XML',    descricao:'Feeds XML para portais imobiliarios', keywords:['portais','xml','feed','vivareal','zap','olx','chaves','imovelweb','123i','url do feed','link do portal','portias','ver portais'], oque_tem:['URLs dos feeds por portal','Data da ultima geracao','Quantidade de imoveis no feed','Padrao VRSync compativel com todos portais'], filtros:[], botoes:['Copiar URL','Regenerar XML','Ver feed'] },
...
const FLUXOS = {
  ...
  gerar_xml:        { titulo:'Gerar XML para portal', rota:'/app/imoveis', keywords:['gerar xml','xml vivareal','xml zap','xml olx','publicar portal','feed portal','como gero xml','gerar feed'], passos:['Va em Meus Imoveis /app/imoveis','Selecione os imoveis com os checkboxes','Na barra inferior escolha o portal (VivaReal, ZAP, OLX...)','Clique em Gerar XML','O link do feed aparece em Portais /app/portais','Copie a URL e envie ao portal'] },
