  ...
  try {
    ...
    const rows = meusImoveis.map(i => {
      ...
      return {
        ...
        'Nome proprietário': prop.nome || i.proprietarioNome || '',
        'Telefone proprietário': prop.telefone || i.proprietarioTelefone || '',
        'Email proprietário': prop.email || i.proprietarioEmail || '',
