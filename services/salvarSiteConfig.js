...
async function salvarConfig(userId, dados) {
  await _inicializar();
  const campos = ['cor_primaria', 'logo_url', 'rodape_nome', 'rodape_telefone', 'rodape_endereco', 'rodape_texto', 'rodape_instagram', 'rodape_facebook', 'site_ativo', 'dominio_personalizado', 'dominio_status', 'dominio_verificado_em', 'cloudflare_hostname_id', 'meta_pixel_id', 'google_analytics_id'];
