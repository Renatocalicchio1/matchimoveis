...
const rotas = [
  ...
  { rota:'/app/cadastro',        label:'Cadastrar Imóvel',       descricao:'Formulário para cadastrar novo imóvel manualmente' },
  ...
  { rota:'/app/portais',         label:'Portais',                descricao:'Gerenciar publicação de imóveis nos portais' },
  { rota:'/app/perfil',          label:'Perfil',                 descricao:'Dados da conta: nome, celular, CRECI, CPF, código do usuário' },
  ...
  { rota:'/app/parceiros',       label:'Parceiros',              descricao:'Corretores parceiros e comissões' },
  { rota:'/app/importar-leads',  label:'Importar Leads',         descricao:'Importar leads via planilha Excel dos portais' },
  { rota:'/app/gerar-xml',       label:'Gerar XML',              descricao:'Gerar XML dos imóveis para portais (VivaReal, ZAP, OLX etc)' },
