...
// não geraram nenhum match. Usado pelo job diário (server.js, 6h) e pelo
// script manual rodarMatchLeadsSemMatch.js (Render Shell). Não passa
...
async function rodarMatchLeadsSemMatch() {
